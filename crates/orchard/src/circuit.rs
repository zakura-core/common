...
impl ProvingKey {
    ...
    /// the three tables account for about 50.1 MiB and took about 62 ms to
    ...
    /// 32 ms. With `orbits`, the two tables account for about 24.8 MiB. Key
    /// generation separately caches about 224 KiB for public-instance
    /// commitments.
    ///
