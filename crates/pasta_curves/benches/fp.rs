...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    group.bench_function("mul_assign/dependent-chain", bench_fp_mul_dependent);
    group.bench_function("square", bench_fp_square);
    group.bench_function("square/dependent-chain", bench_fp_square_dependent);
...
fn bench_fp_mul_dependent(b: &mut Bencher) {
    let mut rng = XorShiftRng::from_seed([
        0x59, 0x62, 0xbe, 0x5d, 0x76, 0x3d, 0x31, 0x8d, 0x17, 0xdb, 0x37, 0x32, 0x54, 0x06, 0xbc,
        0xe5,
    ]);
    let mut state = Fp::random(&mut rng);
...
fn bench_fp_square_dependent(b: &mut Bencher) {
    let mut rng = XorShiftRng::from_seed([
        0x59, 0x62, 0xbe, 0x5d, 0x76, 0x3d, 0x31, 0x8d, 0x17, 0xdb, 0x37, 0x32, 0x54, 0x06, 0xbc,
        0xe5,
    ]);
