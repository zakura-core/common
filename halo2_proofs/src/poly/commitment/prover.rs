...
mod tests {
    use super::{
        compute_ipa_inner_products_pasta, ipa_round_multiexp, parallel_generator_collapse, Params,
    };
    use crate::arithmetic::{best_multiexp, compute_inner_product, CurveAffine};
    use ff::Field;
    use group::{Curve, Group};
